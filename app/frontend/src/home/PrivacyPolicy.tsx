...
export function PrivacyPolicy ()
{
    return <div style={{ padding: 50 }}>
        ...
        <ul>
            ...
            <li>
                <p>By visiting this page on our website: <a href="https://github.com/centerofci/DataCurator/discussions/categories/q-a" rel="external nofollow noopener" target="_blank">https://github.com/centerofci/DataCurator/discussions/categories/q-a</a></p>
            </li>
        </ul>
    </div>
}
