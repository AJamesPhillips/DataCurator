...
export function update_VAPs_with_possibilities (initial_values_and_prediction_sets: StateValueAndPredictionsSet[] | undefined, maybe_value_possibilities: ValuePossibilitiesById | undefined): StateValueAndPredictionsSet[] | undefined
{
