...
import { derive_validity_filter } from "./util"



export function display_options_persist (state: RootState)
{
    const to_persist = pick(["consumption_formatting", "time_resolution", "validity_filter", "validity_formatting"], state.display_options)
